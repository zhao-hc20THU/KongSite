  ...
  return (
    <>
      <PageHero
        ...
        descriptionZh="本页整理孔祥明课题组近五年在水泥化学、化学外加剂、建筑高分子材料和水泥基材料性能调控方面的代表性论文。"
        descriptionEn="This page lists representative publications from the last five years on cement chemistry, chemical admixtures, construction polymers, and performance regulation of cement-based materials."
      />
      <section className="section-pad bg-cement">
        <div className="page-shell">
          <SectionTitle
            titleZh="近五年代表性论文"
            titleEn="Selected Publications from the Last Five Years"
